...
bubble.prototype.rotateBubble = function() {
    this.rotate += this.rotateDirection.value;
    this.rotate %= 360;
}
...
window.addEventListener("load", function() {
   ...
   setInterval(function() {
      ...
      if (bubbleBox.childElementCount <= 20) {
         ...
         // newBubble using rng to choose random bubbles
		 ...
		 var bubbleInterval = setInterval(function() {
		     //fades bubbles eventually, allowing more room for new appended bubbles
