...
function setupStyles() {  
    ...
    document.styleSheets[document.styleSheets.length-1].  insertRule(  
        "div#styleButtons input { background-color: rgba(68, 94, 186, 0.6); border: 3px solid rgba(0, 24, 123, 0.6); border-radius: 50%;  cursor: pointer;  color: white;  display: inline-block;  font-size: 1.2em;  height: 60px; margin: 5px 10px; width: 100px;  }", 1); 
